...
const defaultFlag = {
  pulling: false, pullok: false, pullrelease: false, loading: false, loadok: false, loadrelease: false, status: 'normal',
};
const flagPulling = {
  pulling: true, pullok: false, pullrelease: false, status: 'pulling',
};
const flagPullok = {
  pulling: false, pullok: true, pullrelease: false, status: 'pullok',
};
const flagPullrelease = {
  pulling: false, pullok: false, pullrelease: true, status: 'pullrelease',
};

const flagLoading = {
  loading: true, loadok: false, loadrelease: false, status: 'loading',
};
const flagLoadok = {
  loading: false, loadok: true, loadrelease: false, status: 'loadok',
};
const flagLoadrelease = {
  loading: false, loadok: false, loadrelease: true, status: 'loadrelease',
};
...
export default class JBRefreshBaseView extends Component {
  ...
  */
  ...
  _onPanResponderMove = (e, gesture) => {
    ...
    const gestureDy = gesture.dy / 2; // 减速
